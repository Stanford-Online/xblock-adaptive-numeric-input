module.exports = function (grunt) {
    ...
    var directoryPackage = './adaptivenumericinput';
    ...
    grunt.initConfig({
        ...
        htmlmin: {
            all: {
                ...
                files: {
                    'adaptivenumericinput/public/view.html': directoryPrivate + '/view.html',
                },
            },
        },
        jshint: {
        ...
        less: {
            view: {
                options: {
                    sourceMap: true,
                    sourceMapFilename: 'adaptivenumericinput/public/view.less.min.css.map',
                    outputSourceFiles: true,
                    cleancss: true,
                    compress: true,
                },
                files: {
                    'adaptivenumericinput/public/view.less.min.css':
